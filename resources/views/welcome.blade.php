                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://github.com/rxcod9/joy-voyager-api" class="underline text-gray-900 dark:text-white">Documentation</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    {{ config('app.description', 'Laravel') }}<br/><br/>
                                    #api #laravel #rest-api #swagger #swagger-ui #joy #voyager #voyager-api #joy-voyager-api #passport #voyager-passport
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><b><a href="{{ route('l5-swagger.default.api') }}" class="underline text-gray-900 dark:text-white">Swagger Documentation</a></b></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    You can try swagger api documenation here <b><a href="https://joy-voyager-api.herokuapp.com/api/documentation">https://joy-voyager-api.herokuapp.com/api/documentation</a></b><br/><br/>
                                    Stuck? Do you have general questions or suggestions for improving the joy voyager-api? Feel free to <b><a href="https://github.com/rxcod9/joy-voyager-api/issues">create an issue on GitHub</a></b>, we'll try to address it as soon as possible.
                                </div>
                            </div>
                        </div>
